...
class EclipseReader(ReaderProtocol):
    ...
    def read_wells_data(cls, file_path: str | Path, **kwargs) -> WellsData:
        ...
        t0 = perf_counter()
        summary, wells = cls._load_summary_and_wells(file_path)
    ...
    def prepare_fit_results(
        ...
        results: list[SimulationFitResults] = []
        for well in wells:
